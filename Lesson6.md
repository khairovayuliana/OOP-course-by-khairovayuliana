...
Гораздо лучше было бы сразу создавать поля с нужными значениями. Список инициализации позволяет инициализировать значения полей ещё до запуска тела конструктора, т.е. в момент создания этих самых полей
